...
@Component({
  selector: 'app-after-service-detail',
  templateUrl: './after-service-detail.page.html',
  styleUrls: ['./after-service-detail.page.scss'],
})
export class AfterServiceDetailPage implements OnInit {
